...
public class AeroProtocol {
    ...
    public static class ProtocolMessage {
        ...
        // 添加缺失的方法
        public String getMessageId() { return String.valueOf(requestId); } // 使用requestId作为messageId
    }
    ...
    public static class ProtocolResponse {
        ...
        // 添加ProtocolHandler中使用的构造函数 - 修正参数顺序
        public ProtocolResponse(long requestId, int statusCode, String statusMessage, Map<String, Object> data) {
